...
st.markdown(
    ...
    <style>
    .main-content {
        padding-bottom: 80px; /* Space for the fixed input container */
        z-index: 1;
    ...
    .input-wrapper {
        ...
        gap: 10px !important; /* Space between uploader and chat input */
    }
    .stFileUploader {
        margin: 0 !important; /* Remove default margins */
        padding: 0 !important;
        flex: 1 !important; /* Allow uploader to take available space */
        max-width: 50% !important; /* Limit width to half for side-by-side */
    }
    .stChatInput {
        margin: 0 !important; /* Remove default margins */
        padding: 0 !important;
        flex: 1 !important; /* Allow chat input to take available space */
        max-width: 50% !important; /* Limit width to half for side-by-side */
    }
